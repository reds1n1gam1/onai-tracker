<template>
    <div class="card flex flex-col rounded-md border-2 border-gray-100 py-6 px-12"
        ...
        <div class="card__features flex flex-col gap-2 py-4">
            <div class="card__item flex flex-row justify-start gap-2" v-for="feature in priceItem.features">
...
import { IconCircleCheck, IconUserFilled, IconBolt, IconUsers } from '@tabler/icons-vue';
