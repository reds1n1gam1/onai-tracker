<template>
    <div class="registration bg-white rounded-md py-12 px-10 shadow-lg flex flex-col justify-items-stretch gap-6">
        ...
        <div class="registration__form flex flex-col justify-items-stretch gap-4">
            <div class="grid gap-2">
                <Label class="text-lg" for="name">Full name </Label>
                <InputGroup class="p-2 h-auto">
                    <InputGroupInput class="text-lg" id="name" type="text" placeholder="Enter your name" />
                    <InputGroupAddon>
            ...
            <div class="grid gap-2">
                ...
                <InputGroup class="p-2 h-auto">
                    <InputGroupInput class="text-lg" id="confirm-password" type="password"
            ...
            <div class="flex flex-row gap-2 justify-items-start items-center">
                <Checkbox id="accept" />
                <Label for="accept" class="text-base font-normal">I agree to <a href="" class="text-blue-500 font-semibold">Terms of Service</a> and <a
                href="" class="text-blue-500 font-semibold">Privacy Policy</a></Label>

            </div>
            <Button class="text-lg p-6">Create account</Button>
        </div>
